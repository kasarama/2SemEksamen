...
public class OverlayCalculatorTest {
    ...
    public void countWoodLength() {
        int result = OverlaySizeCalculator.countWoodLength(225);
        int expected = 240;
    ...
    public void screwSpaer() {
        int result = OverlaySizeCalculator.screwSpaer(10);
        int expected = 40;
        assertEquals(expected,result);
    }
    ...
    public void numberOfFyrOnDistance() {
        int result= OverlaySizeCalculator.numberOfFyrOnDistance(6000);
        int expected = 9;
        assertEquals(expected,result);
    }
    ...
    public void fyrNumberOnSide() {
        int result=OverlaySizeCalculator.fyrNumberOnSide(9100);
        int expected = 12;
        assertEquals(expected,result);
    ...
    public void screwFyr() {
        ...
        int actual = OverlaySizeCalculator.screwFyr(12,10); //;
        assertEquals(expected,actual);
    }

    @Test
    public void FyrLengths() {
        ArrayList<Integer> fyrLengths= OverlaySizeCalculator.fyrLengths(2000,10,9100);
    ...
    @Test
    public void areal() {
        double actual=OverlaySizeCalculator.areal(3300,5000, 3);
