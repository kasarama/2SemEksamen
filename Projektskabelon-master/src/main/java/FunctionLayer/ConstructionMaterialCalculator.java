...
public class ConstructionMaterialCalculator {
    ...
    // SKRUER OG BESLAG
    // Hulbånd
    public static int perforatedBand(int length, int width){
    ...
    // Beslagskruer
    public static int bracketScrewsCon(int length){
        // Beslagskruer til hulbånd:
        int bracketScrewsH = (RoofMaterialCalculator.raft(length)-2)*2;
