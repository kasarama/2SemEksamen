...
public class RoofMaterialCalculator {
    ...
    public int quantityOfT600ForRoof(int roofWidth, int roofLength, boolean pitchedRoof)  {
        ...
        int quantityOfT300 = quantityOfT300ForRoof(roofLength, roofWidth, pitchedRoof);
    ...
    public int quantityOfT300ForRoof(int roofLength, int roofWidth, boolean pitchedRoof) {
