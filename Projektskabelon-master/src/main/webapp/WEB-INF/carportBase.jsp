...
<!-- Page content -->
    <div class="container">
        ...
        <div class="centered">
            ...
            <br>
            <a class=" mt-3 btn btn-dark" href="FrontController?target=redirect&destination=?"
               role="button">Login/Registrer</a>
        </div>
    </div>
    ...
    <form name="carportbase" action="FrontController" method="POST">
        ...
        <input type="hidden" name="constructionHeight" value=2000>
        <!-- det her er det eneste sted man angivr constructionens height-->
